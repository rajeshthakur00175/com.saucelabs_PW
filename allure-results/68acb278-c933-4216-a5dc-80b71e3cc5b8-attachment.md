...
- Name: components.spec.ts >> [COMPONENTS] >> [Footer] Links navigation. Validate that User is able to navigate to social platforms using icons.
- Location: tests/components.spec.ts:97:7
