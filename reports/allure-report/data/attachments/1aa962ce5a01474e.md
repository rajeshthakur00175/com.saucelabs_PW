...
- Name: components.spec.ts >> [COMPONENTS] >> [Footer] Static Messages. Validate that User is able to see messages in Footer component.
- Location: tests/components.spec.ts:80:7
...
- article "Server Not Found" [ref=e3]:
  ...
  - generic [ref=e6]:
    ...
    - paragraph [ref=e8]:
      ...
      - strong [ref=e9]: uat.saucedemo.com
    - generic [ref=e10]:
      - heading "What can you do about it?" [level=3] [ref=e11]
      - paragraph [ref=e12]: Try connecting on a different device. Check your modem or router. Disconnect and reconnect to Wi-Fi.
    - paragraph [ref=e13]:
      - link "Learn more…" [ref=e14] [cursor=pointer]:
        - /url: https://support.mozilla.org/1/firefox/150.0.2/Darwin/en-US/server-not-found-connection-problem
