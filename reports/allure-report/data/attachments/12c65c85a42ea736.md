...
- Name: components.spec.ts >> [COMPONENTS] >> [Header] Static Messages. Validate that User is able to see messages in Header component.
- Location: tests/components.spec.ts:33:7
